<x-guest-layout>
    <x-auth-card>
        <x-slot name="logo">
            ...
            <h1 class="mt-6 text-center text-3xl tracking-tight font-bold text-gray-900">Create an account to post a job
            </h1>
            <p class="mt-2 text-center text-sm text-gray-600 max-w-lg">If you already have an account, log in. Then post
                details about your company,the job, and start receiving candidates!</p>
                ...
                <ol role="list" class="space-y-4 md:flex md:space-y-0 md:space-x-8">
                    ...
                    <li class="md:flex-1">
                        ...
                        <div
                            ...
                            <span class="text-sm text-gray-500 font-medium">Step 2</span>
        ...
        <form method="POST" action="{{ route('register.employer.first') }}">
            @csrf
