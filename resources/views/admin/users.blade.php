<x-app-layout>
    ...
    <div class="bg-gray-50">
        ...
        <div class="container py-8 lg:py-12">
            <x-admin-top title="Users" description="A list of all the users in your account including their name,
                        title, email and role." :search_url="route('admin.users.search')" add_url="#" />
