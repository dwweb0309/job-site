<x-app-layout>
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="w-full md:w-1/2 py-24 mx-auto">
            ...
            @endif
            <form action="{{ route('user.update', $user->id) }}" id="payment_form" method="post" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <x-select id="location_id" class="block mt-1 w-full" :items="$locations" item_value="id" item_text="name"
                        name="location_id" :value="old('location_id') ?? $user->profile->location_id" autofocus />
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <x-input id="linkedin_url" autocomplete="" pattern=".*linkedin.com.*"
                            ...
                            type="url" name="linkedin_url" :value="old('linkedin_url') ?? $user->linkedin_url" />
                    </div>
                ...
                <div>
                    ...
                    <x-input id="whatsapp" class="block mt-1 w-full" type="tel" name="whatsapp" :value="old('whatsapp') ?? $user->profile->whatsapp" />
                </div>
                ...
                <div>
                    ...
                    <x-select id="gender" class="block mt-1 w-full" :items="['I prefer not to say', 'Female', 'Male', 'Non-binary', 'Transgender']" name="gender" :value="old('gender') ?? $user->profile->gender"
                        autofocus />
                </div>
                ...
                <div>
                    ...
                    <div class="">
                        <x-input type="number" id="expected_salary" name="expected_salary" placeholder="Salary per year" class="w-full"
                            :value="old('expected_salary') ?? $user->profile->expected_salary" />
