<footer class="bg-gray-50" aria-labelledby="footer-heading">
    ...
    <div class="container pt-16 pb-8 lg:pt-24">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="grid grid-cols-2 gap-8 xl:col-span-2">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h3 class="text-base font-medium text-gray-900">Jobs by industry</h3>
            ...
            <div class="mt-12 md:mt-0">
              <h3 class="text-base font-medium text-gray-900">Jobs by location</h3>
              <ul role="list" class="mt-4 space-y-4">
                <li>
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h3 class="text-base font-medium text-gray-900">For employers</h3>
              <ul role="list" class="mt-4 space-y-4">
                <li>
                  <a href="#" class="text-base text-gray-500 hover:text-gray-900"> Post a job </a>
                </li>

                <li>
                  <a href="#" class="text-base text-gray-500 hover:text-gray-900"> Relocating candidates from the Philippines </a>
                </li>

                <li>
                  <a href="#" class="text-base text-gray-500 hover:text-gray-900"> Relocating candidates from Indonesia </a>
                </li>
            ...
            <div class="mt-12 md:mt-0">
              ...
              <ul role="list" class="mt-4 space-y-4">
                ...
                <li>
                  <a href="#" class="text-base text-gray-500 hover:text-gray-900"> Customer support </a>
                </li>
        ...
        <div class="mt-12 xl:mt-0">
          <h3 class="text-base font-medium text-gray-900">Get notified of new job openings</h3>
          <p class="mt-4 text-base text-gray-500">The latest digest of new job postings, sent to your inbox weekly.</p>
      ...
      <div class="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
        ...
        <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">&copy; 2022 Companies House, Inc. All rights reserved.</p>
      </div>
    </div>
  </footer>