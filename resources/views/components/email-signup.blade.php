<div class="bg-gray-800 rounded-lg my-8">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center">
      <div class="lg:w-0 lg:flex-1">
        <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl sm:tracking-tight" id="newsletter-headline">Get notified of new job opportunities in Dubai</h2>
        <p class="mt-3 max-w-3xl text-lg leading-6 text-gray-300">Sign up to receive notifications of new job postings interesting for you.</p>
      </div>
